                            ...
                            <tr>
                                <td align="left">
                                    <span
                                       ...
                                       You have successfully purchased <strong>{{ $data['plan_name'] }}</strong> investment. Your Investment has started and would be completed on <strong>{{ $data['complete_date'] }}</strong>. Please find investment details below.
                                    </span>
                                </td>
                            </tr>
