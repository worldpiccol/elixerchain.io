                            ...
                            <tr>
                                <td align="left">
                                    <span
                                       ...
                                       You have initiated a deposit of <strong>{{ $data['amount'] }}</strong> into your Bitstocks account. Please find deposit details below:
                                    </span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td align="left"
                                    ...
                                    <ul
                                        ...
                                        <li>
                                           PAYMENT WALLET ADDRESS: {{ $data['wallet'] }}
                                        </li>
                                    </ul>
                                </td>
                            </tr>
