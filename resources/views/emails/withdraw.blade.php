                            ...
                            <tr>
                                <td align="left">
                                    <span
                                       ...
                                       You have initiated a withdrawal of <strong>{{ $data['amount'] }}</strong> from your Bitstocks wallet to an external wallet address. Please find withdrawal details below for referrence:
                                    </span>
                                </td>
                            </tr>
