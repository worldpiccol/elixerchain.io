                            ...
                            <tr>
                                <td align="left">
                                    <span
                                       ...
                                       Your Deposit of <strong>{{ $data['amount'] }}</strong> with transaction ID <strong>#{{ $data['tnx_id'] }}</strong> has successfully be been confirmed on <strong>{{ $data['time'] }}</strong>. Funds have been credited to your Bitstocks wallet.
                                    </span>
                                </td>
                            </tr>
