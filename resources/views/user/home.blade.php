    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Hello, <span class="text-muted">{{ Auth::user()->name }}</span></h4>
            ...
            <div class="card card-h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="text-nowrap">
                        <span class=""><a href="{{ route('user.deposit.create') }}" class="btn btn-soft-success btn-sm">Deposit funds <i class="mdi mdi-arrow-right ms-1"></i></a></span>
                        <span class="ms-2"><a href="{{ route('user.withdraw.create') }}" class="btn btn-soft-warning btn-sm">Withdraw <i class="mdi mdi-arrow-right ms-1"></i></a></span>
                    </div>
                </div><!-- end card body -->
            </div><!-- end card -->
        </div><!-- end col -->
        ...
        <div class="col-md-4">
            ...
            <div class="card card-h-100">
                ...
                <div class="card-body">
                    ...
                    <hr>
                    <div class="text-nowrap">
                        <span class=""> <span class=""><a href="{{ route('user.invest.crypto') }}" class="btn btn-soft-primary btn-sm">Investments<i class="mdi mdi-arrow-right ms-1"></i></a></span></span>
                    </div>
                </div><!-- end card body -->
            </div><!-- end card -->
        </div><!-- end col-->
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-12">
                            ...
                            <h4 class="mb-2">
                                <span class="counter-value" data-target="{{ Auth::user()->referrals->count() }}">0</span>
                            </h4>
                        </div>
                    </div>
                    <hr>
                    <div class="text-nowrap">
                        <span class=""> <span class=""><a href="{{ route('user.referrals') }}" class="btn btn-secondary btn-sm">Referrals <i class="mdi mdi-arrow-right ms-1"></i></a></span></span>
                    ...
                    <div class="table-responsive px-3" data-simplebar style="max-height: 400px;">
                        <table class="table align-middle table-nowrap table-borderless">
                            <tbody>
                                ...
                                @forelse ($latest_transactions as $tran)
                                    <tr class="border-bottom">
                                        ...
                                        @elseif($tran->type ==='rewards' OR $tran->type ==='bonus')
                                            <td style="width: 50px;">
                                                <div class="font-size-22 text-success">
                                                    <i class="bx bx-right-arrow-circle d-block"></i>
                                                </div>
                                        ...
                                        <td>
                                            ...
                                            <td>
                                                <div class="text-end">
                                                    <h5 class="font-size-14 mb-0">{{ round($tran->amount, 6)  }} {{ $tran->crypto->symbol }}</h5>
                                        ...
                                        @elseif($tran->status === 'completed')
                                            <td>
                                                <div class="text-end">
                                                    ...
                                                    <p class="text-muted mb-0 font-size-12">{{ $tran->completed_at->diffForHumans() }}</p>
                                                </div>
                                            </td>
