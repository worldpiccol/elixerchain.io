...
<div class="row mt-5">
    <div class="col-md-12">
       <ul class="nav nav-tabs" >
            <li class="nav-item" >
                <a class="nav-link" href="{{ route('user.invest.crypto') }}" >

                    <span class="d-none d-sm-block">Active Invest</span>
                </a>
            </li>
            <li class="nav-item" >
                <a class="nav-link active"  href="{{ route('user.invest.history') }}" >
    ...
    <div class="col-md-8 offset-md-2">
        <div style="border:none;" class="card">
            ...
            <div class="card-deck mt-2">
                ...
                @forelse ($history_invests as $invest)
