...
<div class="row align-items-center mt-4">
    <div class="col-md-6">
        <div class="mb-3">
            <h5 class="card-title">Total enterie <span class="text-muted fw-normal ms-2">({{ $referrals->count() }})</span></h5>
        </div>
    </div>
</div>
<div class="row align-items-center mt-4">
    <div class="col-md-6 offset-md-2">
        <div class="card">
            <div class="card-body">
                ...
                <div class="p-2">
                    <input id="refer-link" type="text" class="form-control" value="{{ Auth::user()->getReferralLinkAttribute() }}" placeholder="">
