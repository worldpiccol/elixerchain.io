...
<head>
    ...
    <meta name="description"
        content="Hightrove Finance is a global leader in online trading and investing, providing thousands of clients worldwide with access to forex, contracts for difference (CFDs), stockbroking and bonds markets via award-winning platforms.">
    <meta name="keywords"
                            ...
                            <div class="w-100">
                                ...
                                alt="" />
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">&copy; {{ now()->year }}&nbsp; Highttrove Finance, All Rights Reserved</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="carousel-inner">
                                                ...
                                                <div class="carousel-item">
                                                    <div class="testi-contain text-white">
                                                        ...
                                                        <h4 class="mt-4 fw-medium lh-base text-white">“Hightrove is a trading platform that takes the guesswork out of crypto investing. The exchange is designed to help people make a better investment decision by providing the best price and market liquidity.”</h4>
                                                        <div class="mt-4 pt-3 pb-5">
                                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="carousel-item">
                                                    <div class="testi-contain text-white">
                                                        ...
                                                        <h4 class="mt-4 fw-medium lh-base text-white">“Hightrove is a cryptocurrency trading & mining platform that provides the best opportunity for investors to generate more profits by actively trading the markets at all times.”</h4>
                                                        <div class="mt-4 pt-3 pb-5">
