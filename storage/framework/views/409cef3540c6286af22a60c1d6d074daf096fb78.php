...
<head>
    ...
    <!-- <body data-layout="horizontal"> -->
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-2 mb-md-3 text-center">
                                        <a href="<?php echo e(url('/')); ?>" class="d-block auth-logo">
                                            <img src="<?php echo e(asset('dashboard/assets/images/logo-dark.png')); ?>" alt="" width="300">
                                        </a>
                                    </div>
        ...
        <script src="<?php echo e(asset('dashboard/assets/js/pages/pass-addon.init.js')); ?>"></script>
        <script src="<?php echo e(asset('dashboard/assets/js/pages/validation.init.js')); ?>"></script>

    </body>
</html>
<?php /**PATH S:\jobs\bitstocks_trading\resources\views/auth/layouts/app.blade.php ENDPATH**/ ?>