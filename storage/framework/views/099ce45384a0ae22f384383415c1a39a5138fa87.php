...
<head>
        ...
        <link href="<?php echo e(asset('dash/assets/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.css')); ?>" rel="stylesheet" type="text/css" />
         ...
         <!-- alertifyjs Css -->
        <link href="<?php echo e(asset('dash/assets/libs/alertifyjs/build/css/alertify.min.css')); ?>" rel="stylesheet" type="text/css" />
        <!-- preloader css -->
    ...
    <!-- <body data-layout="horizontal"> -->
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            ...
                            <a href="<?php echo e(url('/dashboard')); ?>" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="<?php echo e(asset('dash/assets/images/logo-dark.png')); ?>" alt="" height="24">
                                </span>
                                <span class="logo-lg">
                                    <img src="<?php echo e(asset('dash/assets/images/logo-dark.png')); ?>" alt="" height="24">
                                </span>
        ...
        <!-- alertifyjs js -->
        <script src="<?php echo e(asset('dash/assets/libs/alertifyjs/build/alertify.min.js')); ?>"></script>
...
<?php /**PATH /home/bitsrvud/bit_st/resources/views/user/layouts/app.blade.php ENDPATH**/ ?>