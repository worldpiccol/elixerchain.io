                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item"><a class="dropdown-item" href="crypto.html">CRYPTOCURRENCY</a>
                                        </li>
                                        <li class="nav-item"><a class="dropdown-item" href="forex.html">FOREX TRADING</a>
                                        </li>
                                        <li class="nav-item"><a class="dropdown-item" href="restate.html">REAL ESTAE</a>
                                        </li>
...
<?php /**PATH S:\jobs\htf\resources\views/frontend/welcome.blade.php ENDPATH**/ ?>