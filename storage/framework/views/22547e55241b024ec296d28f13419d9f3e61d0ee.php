                ...
                <div class="row justify-content-center">
                    <div class="col-md-10 col-xl-8">
                        <div class="text-center">
                            <img src="<?php echo e(asset('dashboard/assets/images/verify.png')); ?>" alt="" class="img-fluid">
                        </div>
                    </div>
                    <!-- end row -->
                </div>
...
<?php /**PATH S:\jobs\bitstocks_trading\resources\views/auth/verify.blade.php ENDPATH**/ ?>