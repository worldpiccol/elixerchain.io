...
<head>
        ...
        <!-- plugin css -->
        <link href="<?php echo e(asset('dash/assets/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.css')); ?>" rel="stylesheet" type="text/css" />
    ...
    <!-- <body data-layout="horizontal"> -->
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="<?php echo e(url('/dashboard')); ?>" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                    <img src="<?php echo e(asset('dash/assets/images/logo-dark.png')); ?>" alt="" width="200">
                                </span>
                            </a>
                            <a href="<?php echo e(url('/dashboard')); ?>" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="<?php echo e(asset('dash/assets/images/logo.png')); ?>" alt="" height="24">
                                </span>
                                <span class="logo-lg">
                                    <img src="<?php echo e(asset('dash/')); ?>assets/images/logo.png" alt="" height="24">
                                </span>
        ...
        <!-- apexcharts -->
        <script src="<?php echo e(asset('dash/assets/libs/apexcharts/apexcharts.min.js')); ?>"></script>

         <!-- Required datatable js -->
        <script src="<?php echo e(asset('dash/assets/libs/datatables.net/js/jquery.dataTables.min.js')); ?>"></script>
        <script src="<?php echo e(asset('dash/assets/libs/datatables.net-bs4/js/dataTables.bootstrap4.min.js')); ?>"></script>

        <!-- Responsive examples -->
        <script src="<?php echo e(asset('dash/assets/libs/datatables.net-responsive/js/dataTables.responsive.min.js')); ?>"></script>
        <script src="<?php echo e(asset('dash/assets/libs/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js')); ?>"></script>

        <!-- Plugins js-->
        <script src="<?php echo e(asset('dash/assets/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.min.js')); ?>"></script>
        <script src="<?php echo e(asset('dash/assets/libs/admin-resources/jquery.vectormap/maps/jquery-jvectormap-world-mill-en.js')); ?>"></script>
        <!-- dashboard init -->
...
<?php /**PATH /home/bitsrvud/bit_st/resources/views/admin/layouts/app.blade.php ENDPATH**/ ?>