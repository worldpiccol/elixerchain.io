<?php $__env->startSection('title', 'Create Binary Scheme'); ?>;
...
<div class="row">
    <div class="col-lg-12">
        <div class="card mt-4">
            ...
            <div class="card-body">
                <div>
                    <form id="" method="post" action="<?php echo e(route('admin.binary.store')); ?>">
                        <?php echo csrf_field(); ?>
                        <input type="hidden"/>
                        <div class="row">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH S:\jobs\bitstocks_trading\resources\views/admin/bi_schemes/create.blade.php ENDPATH**/ ?>