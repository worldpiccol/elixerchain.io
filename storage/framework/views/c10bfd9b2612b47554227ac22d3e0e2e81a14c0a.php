        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Crypto Stakes</a></li>
...
<div class="row mt-5">
    <div class="col-md-12">
       <ul class="nav nav-tabs" >
            <li class="nav-item" >
                <a class="nav-link" href="<?php echo e(route('user.invest.crypto')); ?>" >

                    <span class="d-none d-sm-block">Active Invest</span>
                </a>
            </li>
            <li class="nav-item" >
                <a class="nav-link active"  href="<?php echo e(route('user.invest.history')); ?>" >
    ...
    <div class="col-md-8 offset-md-2">
        <div style="border:none;" class="card">
            ...
            <div class="card-deck mt-2">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $history_invests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <?php echo $history_invests->links(); ?>
...
<?php echo $__env->make('user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH S:\jobs\bitstocks_trading\resources\views/user/crypto-invest/history.blade.php ENDPATH**/ ?>