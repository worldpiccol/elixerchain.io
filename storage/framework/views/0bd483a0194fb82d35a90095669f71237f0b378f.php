            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 footers-one">
                    <div class="footers-logo">
                        <a href="<?php echo e(url('/')); ?>">
                            <img src="<?php echo e(asset('frontend/img/logo.png')); ?>" width="350" class="img-fluid" alt="Logo">
                        </a>
                    </div>
                    <div class="footers-info mt-3">
                        <p>"Bitstocks is not just a company, it's a mission"<br> - Michael Hudson, Founder and CEO </p>
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-2 footers-two">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="<?php echo e(url('/about-us')); ?>">Meet the team</a></li>
                    </ul>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-2 footers-three">
                    <h5>Information</h5>
                    <ul class="list-unstyled">
                        <li><a href="<?php echo e(route('login')); ?>">Register Now</a></li>
                        <li><a href="<?php echo e(url('/staking')); ?>">Staking</a></li>
                        <li><a href="<?php echo e(url('/cryptocurrency-trading')); ?>">Crypto Trading</a></li>
                        <li><a href="<?php echo e(url('/stocks-trading')); ?>">Stocks Trading</a></li>
                    </ul>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-2 footers-five">
                    <h5>Legal </h5>
                    <ul class="list-unstyled">
                        <li><a href="<?php echo e(asset('frontend/doc/Certificate-of-Inc.pdf')); ?>">Certificate of Incorporation</a></li>
                        <li><a href="<?php echo e(asset('frontend/doc/Tax-insurance.pdf')); ?>">Tax & Insurance </a></li>
                        <li><a href="<?php echo e(asset('frontend/doc/Anti-laundering.pdf')); ?>">Guide to Anti Laundering</a></li>
                        <li><a href="<?php echo e(asset('frontend/doc/Brochure.pdf')); ?>">Company Brochure</a></li>
                        <li><a href="<?php echo e(asset('frontend/doc/Fin-statement-2021.pdf')); ?>">Financial Statement 2021</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="copyright" style="background-color: var(--color-secondary);">
        ...
        <footer class="footer">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <p class="copyright font-alt">&copy; <?php echo e(now()->year); ?>&nbsp; Bitstocks Trading Limited, All Rights Reserved
                        </p>
                    </div>
                    <div class="col-sm-6">
                        <div class="footer-social-links"><a href="<?php echo e(url('/terms')); ?>">Terms</a><a href="<?php echo e(url('/risks-disclosure')); ?>">Risk
                                Disclosure</a><a href="<?php echo e(url('/privacy-policy')); ?>">Privacy Policy</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH S:\jobs\bitstocks_trading\resources\views/frontend/panels/footer.blade.php ENDPATH**/ ?>